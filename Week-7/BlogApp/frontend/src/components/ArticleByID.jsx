...
function ArticleByID() {
  ...
  useEffect(() => {
    ...
    const getArticle = async () => {
      ...
      try {
        const res = await axios.get(`http://localhost:4000/user/article/${id}`, { withCredentials: true });
  ...
  const addComment = async (commentObj) => {
    ...
    let res = await axios.put("http://localhost:4000/user/articles", commentObj, { withCredentials: true });
    if (res.status === 200) {
